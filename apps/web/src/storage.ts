...
import { createInitialLearnerState, normalizeLearnerState, type LearnerState } from "@hero-lang/learning-engine";
import type { LabyrinthSession } from "./labyrinth";

const STATE_KEY_PREFIX = "hero-language-camp:v0.9:state";
const LEGACY_STATE_KEYS = ["hero-language-camp:v0.8:state", "hero-language-camp:v0.7:state", "hero-language-camp:v0.6:state", "hero-language-camp:v0.3:state", "hero-language-camp:v0.2:state", "hero-language-camp:state"];
const LANGUAGE_KEY_PREFIX = "hero-language-camp:v0.7:base-language";
const LEGACY_LANGUAGE_KEY_PREFIX = "hero-language-camp:v0.3:base-language";
const PROFILES_KEY = "hero-language-camp:v0.9:profiles";
const ACTIVE_PROFILE_KEY = "hero-language-camp:v0.9:active-profile";
const SETTINGS_KEY = "hero-language-camp:v0.9:settings";
const VIEWPORT_SETTINGS_KEY = "hero-language-camp:v0.12:viewport-settings";
const LABYRINTH_KEY_PREFIX = "hero-language-camp:v0.11:labyrinth";
...
function defaultProfiles(): ChildProfile[] {
  return [
    { id: "kid_1", name: "Ani", appearance: DEFAULT_APPEARANCES[0] },
    { id: "kid_2", name: "Narek", appearance: DEFAULT_APPEARANCES[1] }
  ];
}
